...
class DataPreprocessor:
    ...
    def cleaning_data(self, df):
        ...
        # Handling outliers in 'Months_on_book' column
    ...
    def preprocess(self):
        ...
        # Imputation, encoding, scaling, and oversampling
        ...
        # Reusing label encoder for both y_train and y_test
        label_encoder = LabelEncoder()
        y_train = label_encoder.fit_transform(y_train)
        y_test = label_encoder.transform(y_test)

        # After preprocessing, store original feature names
